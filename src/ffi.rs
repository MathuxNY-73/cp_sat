...
/// Struct that holds the context of a Rust closure througth the FFI boundary. The closure is stored
/// as mutable void pointer.
/// This mutable void pointer is passed, by the foreign code, as an argument of a "free" function and
/// cast back to the closure object before being called.
...
/// The `observer` is a callback that will be called on every feasible solution and should return
/// a [bool] to tell whether or not the solver should continue searching.
/// Returns an instance of
/// [CpSolverResponse][crate::proto::CpSolverResponse].
